...
<table>
	...
	@endphp
  	<tr>
		...
		<td></td>
		<td></td>
		<td style="text-align: right;">@rupiah(saldoawaltanggal($data['tanggalawal']))</td>
  	</tr>  	
...
<div class="row">
	<br>
	<p class="ttd" style="text-indent: 15px;">Saldo Tunai <strong>@rupiah(carisaldoalltunaitanggal($data['tanggalakhir']))</strong></p>
