...
<?php $__env->startSection('master'); ?>
        	...
        	<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
                  	<?php  
				        $no=1;
				    ?>
					<?php $__currentLoopData = $matangd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<tr>
						<td><?php echo e($no); ?></td>
						...
						<td>
							<a href="#" data-toggle="modal" data-target="#editmatangd-<?php echo e($data->id); ?>" class="btn btn-warning btn-sm">Ubah</a>							
	...
	<!-- Modal edit -->
	<?php $__currentLoopData = $matangd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	<div class="modal fade" id="editmatangd-<?php echo e($data->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<form action="/matangd/<?php echo e($data->id); ?>/edit" method="POST">
						<?php echo e(csrf_field()); ?>
