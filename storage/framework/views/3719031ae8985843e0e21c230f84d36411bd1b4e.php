...
<p class="judul2"><strong>BUKU KAS UMUM</strong></p>
...
<table>
  	...
  	<?php  
	    ...
	    $nilaid=0;
	    $nilaik=0;
	    $saldo=saldoawaltanggal($data['tanggalawal']);
	    $no=2;
	?>
  	<tr>
		...
		<td></td>
		<td></td>
		<td style="text-align: right;"><?php echo number_format(saldoawaltanggal($data['tanggalawal']),2,',','.'); ?></td>
  	</tr>  	
...
<div class="row">
	<br>
	<p class="ttd" style="text-indent: 15px;">Saldo Tunai <strong><?php echo number_format(carisaldoalltunaitanggal($data['tanggalakhir']),2,',','.'); ?></strong></p>
