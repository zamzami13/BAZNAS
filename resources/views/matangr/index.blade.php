...
@section ('master')
        	...
        	<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>{{$data->kdlevel}}</td>
						<td>
							<a href="#" data-toggle="modal" data-target="#editmatangr-{{$data->id}}" class="btn btn-warning btn-sm">Ubah</a>							
	...
	<!-- Modal edit -->
	@foreach($matangr as $data)
	<div class="modal fade" id="editmatangr-{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<form action="/matangr/{{$data->id}}/edit" method="POST">
						{{csrf_field()}}
						<div class="form-group">
							<label>Kode Akun</label>
