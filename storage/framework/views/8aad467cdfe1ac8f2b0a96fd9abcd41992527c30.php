...
<!-- 					<div class="form-group">
						...
						<select id="matangr_id" name="matangr_id[]" class="form-control form-control-sm" onchange="ambilsumberdana(event)">
							<?php $__currentLoopData = $matangr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option value="<?php echo e($r->id); ?>"><?php echo e($r->nmrek); ?></option>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                          
	                    </select>
					</div> -->
					<div class="form-group">
...
<script src="<?php echo e(asset('adminlte/plugins/select2/js/select2.full.min.js')); ?>"></script>
	<script type="text/javascript">
        ...
        $("#validasi_submit").on('click', function(){
        		...
        		$.post("<?php echo e(url('pengeluaran/validasi-tambah')); ?>", {jenis: $jenis_transaksi, akun: $arr_akun, jumlah: $arr_jumlah, sumber:$arr_sumber}, function(respon){
        				console.log(respon);
        ...
        $("#entri_nomor").on('change', function(){
        	$nomor = $(this).val();
        	if($nomor.length==5){
        		$.get("<?php echo e(url('pengeluaran/cek-nomor')); ?>?nomor="+$nomor, function(respon){
        			if(respon.status!=true){
